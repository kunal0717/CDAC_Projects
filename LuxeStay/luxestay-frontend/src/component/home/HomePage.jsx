        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.jpg" alt="LuxeStay Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="luxestay-color">LuxeStay</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="luxestay-color">LuxeStay</span></h2>
            ...
            <section className="service-section"><div className="service-card">
                ...
                <div className="service-card">
                    <img src="./assets/images/beer.png" alt="Mini Bar" />
                    <div className="service-details">
